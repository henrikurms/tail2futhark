...
fun real main() =
  ...
  let t_v1 = reshape((if (0 <= (size(0,t_v0) - if (1 <= 0) then -1 else 1)) then (size(0,t_v0) - if (1 <= 0) then -1 else 1) else 0,size(1,t_v0)),drop1_int((1 * (size(1,t_v0) * 1)),reshape(((size(0,t_v0) * (size(1,t_v0) * 1))),t_v0))) in

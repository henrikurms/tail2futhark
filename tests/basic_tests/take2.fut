...
fun real main() =
  let t_v1 = reshape((if (2 <= 0) then -2 else 2,size(1,reshape((3,3),reshape1_int((3 * (3 * 1)),reshape(((size(0,map(fn int (int x) => (x + 1),iota(9))) * 1)),map(fn int (int x) => (x + 1),iota(9))))))),take1_int((2 * (size(1,reshape((3,3),reshape1_int((3 * (3 * 1)),reshape(((size(0,map(fn int (int x) => (x + 1),iota(9))) * 1)),map(fn int (int x) => (x + 1),iota(9)))))) * 1)),reshape(((size(0,reshape((3,3),reshape1_int((3 * (3 * 1)),reshape(((size(0,map(fn int (int x) => (x + 1),iota(9))) * 1)),map(fn int (int x) => (x + 1),iota(9)))))) * (size(1,reshape((3,3),reshape1_int((3 * (3 * 1)),reshape(((size(0,map(fn int (int x) => (x + 1),iota(9))) * 1)),map(fn int (int x) => (x + 1),iota(9)))))) * 1))),reshape((3,3),reshape1_int((3 * (3 * 1)),reshape(((size(0,map(fn int (int x) => (x + 1),iota(9))) * 1)),map(fn int (int x) => (x + 1),iota(9)))))))) in
  toFloat(reduce(+,0,[size(0,t_v1),size(1,t_v1)]))
...
\end{tabular}
    \caption{Transformation rules for ???}
\end{figure}
...
\end{tabular}
    \caption{Transformation rules for lambda expressions}
\end{figure}
...
\caption{Transformation rules for library functions}
\end{figure}
...
$\evals{$shri$}_{op}$ & $=$  & $>>$  \\
\end{tabular}
\caption{Transformation rules for binary operators}
\end{figure}

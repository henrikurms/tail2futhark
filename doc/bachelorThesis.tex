...
% We only used benchmarks to see if there was an increse in effiecency of the code and there was but we did not look into the why this increse is there. It could therefore have be interesting to also focus on what about the two compilers (APLTAIL and Futhark) that could be responsible for the differencies. 

...
We have defined four take functions (one of each base type) that are generated from a template. Below
is the int version
...
These functions inplement the the TAIL operator reshape in the 1-dimensional case and we will se later
that they can be used to implement the multi-dimensional case.

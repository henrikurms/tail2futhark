...
\paragraph{Var, let-expressions}

 
   almost are equivalent to Futhark let-expressions. The only difference is that the type information that exists in TAIL are ignored in Futhark. 

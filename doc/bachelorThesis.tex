...
the context in which the lambda is used. Namely the type informations is present in the instance lists of the 
...
the TAIL compiler will inline all functions bound to variables when compiling form APL. This means that lambda expressions can only occur

...
To keep the implementation scheme simple we have made a small libery of functions ...\\ % explain why this is smart
...
There are several reasons for making libary functions. One was to keep our compilation scheme simple. By haveing a  small library of Furhark functions which is inlined in each compiled program we... % ja hvad får vi egentlig ud af det??? :)
...
% definition of each of the libery functions

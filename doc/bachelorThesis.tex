...
In recent years, there has been a lot of focus on leveraging the power of parallel hardware because of the promise it offers for faster exextution afther the exponential growth curve for computer power on secuential hardware (explaind as Moore's Law) broke around 2006. 
...
andi			& iIMPL IS WRONG!! & 	how to test this in apl???	 & \\
...
rotate		& NOT TESTET	OR IMPL	&						&  \\
reverse		& NOT TESTET	OR IMPL	&						&  \\

...
$\evals{\text{each}(f,a)}$ & $=$ & $  \begin{cases}
                                                                 ...
                                                                 \end{cases}$\\
=======
$\evals{\text{each}_{[t,r]}(f,a)}$ & $=$ & $ \begin{cases}
                                                                               a , r=0 \\
                                                                               $map$(\evals{f},\evals{a}) , r=1\\
                                                                               $map (fn $x$ {\tt =>} $ \evals{\text{each}_{[t,r-1]}(f,x)},\evals{a}) , r > 1  \\
                                                                           \end{cases}$\\
$\evals{\text{reduce}_{[t,r]}(f,n,a)}$ & $=$ & $ \begin{cases}
                                                                               \text{reduce}(\evals{f},\evals{n},\evals{a}) , r=1 \\
                                                                               $map (fn $x$ {\tt =>} $ \evals{\text{reduce}_{[t,r-1]}(f,n,x)},\evals{a}) , r>1\\
                                                                           \end{cases}$\\
>>>>>>> 95cb920d365a335506b22ddc0ff604034c6fbc0c
\end{tabular}\\

...
Like the other tree operators it works on the inner-most dimention of the array\cite{ElsmanDybdal:Array:2014}. \\
...
Except for inline anonymus functions all functions are defined globaly \cite{TroelsHenriksen}. \\
...
$\evals{\text{each}(f,a)}$ & $=$ & $  \begin{cases}
                                                                 a , r=0 \\
                                                                 ... \\
                                                                 ... \\
                                                                 \end{cases}$\\

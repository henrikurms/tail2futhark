...
$\evals{\text{each}_{[t_1,t_2,r]}(f,a)}$ & $=$ & $ \begin{cases}
                                                                               $map$(\evals{f},\evals{a}) & r=1\\
                                                                               $map (fn $tp(t_2,r) \; (\evals{t_1} \; x)$ {\tt =>} $ \evals{\text{each}_{[t,r-1]}(f,x)},\evals{a}) & r > 1  \\
                                                                           \end{cases}$\\
                                                                           
$\evals{\text{reduce}_{[t,r]}(f,n,a)}$ & $=$ & $ \begin{cases}
                                                                               \text{reduce}(\evals{f},\evals{n},\evals{a}) & r=1 \\
                                                                               $map (fn $ tp(t,r) \; (\evals{t} \; x)$ {\tt =>} $ \evals{\text{reduce}_{[t,r-1]}(f,n,x)},\evals{a}) & r>1\\
                                                                           \end{cases}$\\
                                                                           
$\evals{\text{zipWith}_{[t_1,t_2,t_3,r]}(f,a_1,a_2)}$ & $=$ & $\begin{cases}
                                                                               $map$(\evals{f},$zip($\evals{a_1},\evals{a_2}) & r=1 \\
                                                                               $map( fn $tp(t_3,r) \; (\evals{t_1} \; x, \evals{t_2} \; y) $ {\tt =>} $\\
                                                                                \evals{\text{zipWith}_{[t_1,t_2,t_3r-1]}(f,x,y)} , $zip($ \evals{a_1},
                                                                                \evals{a_2}) & r>1\\
                                                                               \end{cases}$\\
...
$\evals{\text{op} [e_1,e_2]}$ & $=$ & $\evals{e_1} \; \evals{op}_{fun} \; \evals{e_2}$\\
$\evals{addi}_{op}$ & $=$ & $+$\\

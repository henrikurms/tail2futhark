...
The implimintation of the compiler is written in the functional programming language Haskell. We chose to write in Haskell because it is a functional language that lend itself to ????????????????
